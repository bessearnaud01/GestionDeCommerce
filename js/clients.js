...
let maxpages = Math.ceil(clients.length / numberOfItems);
let tableList = '';
...
function showList(){
        ...
        for(let i = first; i < first + numberOfItems;i++){
         if(i<clients.length){
          ...
          <tr>
            ...
            <td> <a href="EditerClient.php?&id=${clients[i].idClient}" target="_self"><i class="fas fa-edit"></i></a> &nbsp
            <a onclick ="return confirm(' Êtes vous sûr de vouloir supprimer le client')";
                href="SupprimerClient.php?&id=${clients[i].idClient}" target="_self"> <i class="fas fa-trash-alt"></i> </a>
            </td>
        </tr>
    ...
    document.getElementById('clients').innerHTML = tableList;
    showPageInfo();
  }
