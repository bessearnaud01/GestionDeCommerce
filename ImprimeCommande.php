...
class MYPDF extends TCPDF {
     ...
     public function Header(){
        ...
        $this->Cell(0,10,'Listes des commandes',0,false,'C');
 
     }

    // Colored table
    public function ColoredTable($header,$commande) {
        ...
        foreach($commande as $row) {
            $this->Cell($w[0],6, $row->getIdCommande(), 'LR', 0, 'L', $fill);
            $this->Cell($w[2],6, $row-> getNomClient(), 'LR', 0, 'L', $fill);
...
// column titles
$header = array('N°prdt', 'Client','Nm du prdt','PU','Qtté','Mtt à payer','Date');
...
// print colored table
$pdf->ColoredTable($header, $commande);
