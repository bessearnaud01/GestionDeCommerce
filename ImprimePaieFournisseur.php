...
spl_autoload_register(function ($class_name) {
    ...
    $Fournisseur =  $bddPaiementFournisseur ->read();
...
class MYPDF extends TCPDF {
    ...
    public function Header(){
        ...
        $this->Cell(0,10,'La listes des paies de fournisseur',0,false,'C');
    ...
    public function ColoredTable($header, $Fournisseur) {
        ...
        foreach( $Fournisseur as $row) {
            $this->Cell($w[0],6, $row->getIdPaieFournisseur(), 'LR', 0, 'L', $fill);
            $this->Cell($w[1],6, $row-> getNomFournisseur(), 'LR', 0, 'L', $fill);
...
// column titles
$header = array('N°Paiment', 'N°frnisseur','Mtt verse','Solde','Statut','Date ');
